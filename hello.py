...
class NameForm(FlaskForm):
    ...
    role = SelectField('Disciplina associada:', choices=[('DSWA5'), ('GPSA5'), ('IHCA5'), ('SODA5'), ('PJIA5'), ('TCOA5')])
...
def unavailable(option):
    ...
    title = title_map.get(option, 'Não disponível')
    return render_template('unavailable.html', title=title)



@app.route('/', methods=['GET'])
def index():
    aluno_nome = "Maria Eduarda Melim de Oliveira"
    prontuario = "PT3025594"
    data_hora_local = datetime.now().strftime("%B %d, %Y %I:%M %p")
